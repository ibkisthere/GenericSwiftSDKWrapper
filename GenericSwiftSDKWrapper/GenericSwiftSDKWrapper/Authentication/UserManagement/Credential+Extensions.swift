...
//    public static let defaultCredentialChanged = Notification.Name("com.genericsdk.defaultCredentialChanged")
//
...
//    public static let credentialCreated = Notification.Name("com.genericsdk.credential.created")
//
//    /// Notification broadcast when a credential is removed from storage.
//    public static let credentialRemoved = Notification.Name("com.genericsdk.credential.removed")
//
//    /// Notification broadcast when a credential has been migrated from a previous version.
//    public static let credentialMigrated = Notification.Name("com.genericsdk.credential.migrated")
//
//    /// Notification broadcast when a credential fails to refresh.
//    public static let credentialRefreshFailed = Notification.Name("com.genericsdk.credential.refresh.failed")
//}
//
//#if swift(>=5.5.1)
